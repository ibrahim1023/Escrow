...
impl Pack for Escrow {
    ...
    fn unpack_from_slice(src: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(Escrow {
            ...
            temp_token_account_pubkey: Pubkey::new_from_array(*temp_token_account_pub),
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        temp_token_account_pub_dst.copy_from_slice(temp_token_account_pubkey.as_ref());
        initializer_token_to_receive_account_pubkey_dst
